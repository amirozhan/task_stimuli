...
python main.py   --subject 02   --session 5 --blocks 1-10 --tasks mutemusic   --output output/sub02_AR_E5_B1-B10  --no-force-resolution   --run_on_battery   --skip-soundcheck --fmri55