...
python main.py   --subject 03   --session 02 --blocks 1-10 --tasks mutemusic   --output output/AS_sub_03_ses_02   --no-force-resolution   --run_on_battery   --skip-soundcheck --fmri