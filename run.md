...
python main.py   --subject 00   --session 3 --blocks 11-20 --tasks mutemusic   --output output/sub00_GG_E3_B11-B0  --no-force-resolution   --run_on_battery   --skip-soundcheck --fmri